...
/**
 * @deprecated `@splunk/ui-utils/boolean` is deprecated and will be removed in a future major version. Use `@splunk/splunk-utils/boolean` instead.
 *
 ...
 * * `'true'`
 *
 * Returns `false` if the value is one of the following:
 * * `false`
 * * `0`
 * * `'0'`
 * * `'no'`
